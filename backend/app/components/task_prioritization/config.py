...
# MongoDB configuration (uses TASKS_* env vars to avoid collision)
TASKS_MONGODB_URI = os.getenv("TASKS_MONGODB_URI", "")
TASKS_MONGODB_DATABASE = os.getenv("TASKS_MONGODB_DATABASE", "research_task_db")
TASKS_MONGODB_COLLECTION = os.getenv("TASKS_COLLECTION_TASKS", "tasks")
