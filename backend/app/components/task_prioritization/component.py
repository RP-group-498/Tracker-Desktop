...
class TaskPrioritizationComponent(ComponentBase):
    ...
    def initialize(self, config: Dict[str, Any]) -> None:
        ...
        self._mongodb_uri = os.getenv("TASKS_MONGODB_URI", "")
        self._mongodb_database = os.getenv("TASKS_MONGODB_DATABASE", "research_task_db")
        self._mongodb_collection = os.getenv("TASKS_COLLECTION_TASKS", "tasks")
